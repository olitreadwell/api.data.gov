...
- 2026-09-09 self-found gap — UsageChart.js mutates the `hits` prop (and the shared pinia store monthly array) via `data.hits.pop()` when title === "All Time". See Mined gaps. outcome: pr-opened (PR #3).
